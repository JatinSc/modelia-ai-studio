...
const UploadImage: React.FC<UploadImageProps> = ({
  ...
  return (
    <div className="max-h-[30vh] bg-white rounded-xl shadow-sm border border-gray-200 p-6 min-h-[100%]">
      {/* Header */}
      ...
      {!uploadedImage ? (
        ...
        <div className="relative">
          <div className="relative rounded-lg overflow-hidden border border-gray-200">
            ...
            <button
              onClick={removeImage}
              className="absolute top-3 right-3 p-1.5 bg-gray-800 text-white rounded-full hover:bg-red-700 transition-colors duration-200 shadow-sm"
